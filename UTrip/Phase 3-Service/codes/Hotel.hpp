...
public:
    ...
    std::string get_img_url() { return image_url; }
    std::string get_overview() { return hotel_overview; }
    std::string get_amenities() { return property_amenities; }
